...
export async function GET(request: Request) {
  ...
  if (!itemRows.results.some((row: Record<string, unknown>) => row.kind === "module")) {
    const modules = [["chat","Parler à Morice","✦"],["mail","Mail & Brouillons","✉"],["hubspot","HubSpot","◎"],["tasks","Tâches","✓"],["calendar","Agenda","□"],["approvals","Validations","◆"],["documents","Documents","▤"],["memory","Mémoire","◉"],["connections","Connexions","⌁"]];
